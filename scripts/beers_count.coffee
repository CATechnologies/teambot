...
#
# hubot <user> beers count + <int>      - Add beers to the user
# hubot <user> beers count - <int>      - Remove beers to the user
# hubot give me <user> beers count      - Return the beer count for the user
